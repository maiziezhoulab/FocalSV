...
In our paper, we benchmarked the large INDEL call on HG002, TRA INV DUP on HCC1395, so here we provide the fastq download link and minimap2 alignment commands for HG002 Hifi_L1 and HCC1395 data.
